...
var _class = function (_PureComponent) {
  ...
  function _class() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = _class.__proto__ || (0, _getPrototypeOf2.default)(_class)).call.apply(_ref, [this].concat(args))), _this), _this.handlerSee = function () {
  ...
  (0, _createClass3.default)(_class, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        type === 7 ? _react2.default.createElement(
          'span',
          { className: 'see',
            onClick: this.handlerShare },
          '\u5206\u4EAB\u6709\u793C'
        ) : _react2.default.createElement(
          'span',
          { className: 'see',
            onClick: this.handlerSee },
          '\u4E00\u952E\u4F53\u9A8C'
        )
      );
    }
